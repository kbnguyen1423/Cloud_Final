### Author Details ###
### Name: Abhigyan Acherjee, Kevin Nguyen
### Cloud Final Project
...
database = 'cloud-data-3'
hostname = 'cloud-project-1.mysql.database.azure.com'
root_ca = '/Users/abhiacherjee/Desktop/Dash_App_2/Cloud-Computing-Final-Project/CS6065_Final_Public/DigiCertGlobalRootCA.crt.pem'
...
# Correct way to autoload the table schema from the database
...
def display_dashboard():
    ...
    dashboard_layout = html.Div(children=[
        ...
        html.H3('Abhigyan Acherjee and Kevin Nguyen'),
        html.Br(),
